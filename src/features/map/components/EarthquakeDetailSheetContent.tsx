 ...
 */
export const EarthquakeDetailSheetContent: React.FC<EarthquakeDetailSheetContentProps> = ({
  earthquake,
}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <DetailRow label="Derinlik" value={`${earthquake.depthKm.toFixed(1)} km`} />
      <DetailRow
        label="Koordinatlar"
        value={`${earthquake.latitude.toFixed(4)}, ${earthquake.longitude.toFixed(4)}`}
      />
      <DetailRow label="Kaynak" value={earthquake.source} />
    </View>
  );
};
