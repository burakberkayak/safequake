...
export const FamilyScreen: React.FC = () => {
  ...
  const [selectedRelation, setSelectedRelation] =
    useState<FamilyMember["relation"]>("Diğer");
  ...
  const handleAddMember = () => {
    try {
      ...
      Alert.alert(
        ...
        language === "tr"
          ? "Yakınınız acil durum listesine eklendi."
          : "Relative added to emergency list.",
      );
      setName("");
      setPhone("");
      ...
      Alert.alert(
        ...
        err.message ||
          (language === "tr"
            ? "Lütfen ad soyad ve telefon numarasını doldurun."
    ...
    >
      ...
      >
        <View style={styles.cardHeaderRow}>
          <View
            style={[styles.cardHeaderIcon, { backgroundColor: "#2E7D3215" }]}
          >
          ...
          <View style={styles.cardHeaderTextGroup}>
            <Text style={[styles.statusTitle, { color: colors.onSurface }]}>
              {language === "tr"
                ? "Aile & Acil Durum Mesaj Ağı"
                : "Family Emergency Safety Network"}
            </Text>
            <Text
              style={[styles.statusDesc, { color: colors.onSurfaceVariant }]}
            >
              {language === "tr"
        ...
        >
          <View style={styles.safeButtonContent}>
            ...
            <Text style={styles.safeButtonText}>
              {language === "tr"
                ? "GÜVENDEYİM / ACİL MESAJ GÖNDER"
                : "SEND SAFETY STATUS / SMS"}
            </Text>
          </View>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.sectionHeader}>
        <Text style={[styles.sectionTitle, { color: colors.onBackground }]}>
          {language === "tr"
            ? `Yakınlarım (${familyMembers.length})`
            : `My Family (${familyMembers.length})`}
        </Text>
        <TouchableOpacity
      ...
      {showAddForm && (
        ...
        >
          ...
          <TextInput
            ...
            placeholder={
              language === "tr" ? "Ad Soyad (Örn: Ahmet Yılmaz)" : "Full Name"
            }
          ...
          <TextInput
            ...
            placeholder={
              language === "tr"
                ? "Telefon Numarası (Örn: 05551234567)"
                : "Phone Number"
            }
            placeholderTextColor={colors.onSurfaceVariant + "70"}
            value={phone}
              ...
              <View style={styles.memberNameRow}>
                ...
                >
                  <Text style={[styles.tagText, { color: colors.primary }]}>
                    {relLabels[item.relation] || item.relation}
                  </Text>
                </View>
              </View>
              <Text
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={[styles.emptyTitle, { color: colors.onSurface }]}>
              {language === "tr"
                ? "Henüz Yakın Eklenmemiş"
                : "No Relatives Added"}
            </Text>
            <Text
              style={[styles.emptyDesc, { color: colors.onSurfaceVariant }]}
            >
              {language === "tr"
